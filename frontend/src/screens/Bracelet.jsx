...
import styles from '../styles/Bracelet.module.css';
...
const Bracelet = () => {
  ...
  return (
    <>
      <div className={styles['bracelet-page']}>
        {/* Slideshow Section */}
              ...
              <div key={index} className={styles.slide}>
                ...
                <div className={styles['slide-overlay']}>
                  <div className={styles['slide-content']}>
                    <h2 className={styles['slide-title']}>Exquisite Bracelets</h2>
                    <p className={styles['slide-subtitle']}>Discover our premium collection of handcrafted bracelets</p>
        ...
        <div className={styles['header-section']}>
          <div className={styles['header-content']}>
            <h1 className={styles['header-title']}>Premium Bracelet Collection</h1>
