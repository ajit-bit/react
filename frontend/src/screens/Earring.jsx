...
import styles from '../styles/Earring.module.css';
...
const Earring = () => {
  ...
  return (
    <>
      <div className={styles['earring-page']}>
        {/* Slideshow Section */}
              ...
              <div key={index} className={styles.slide}>
                ...
                <div className={styles['slide-overlay']}>
                  <div className={styles['slide-content']}>
                    <h2 className={styles['slide-title']}>Exquisite Earrings</h2>
                    <p className={styles['slide-subtitle']}>Discover our premium collection of handcrafted earrings</p>
        ...
        <div className={styles['header-section']}>
          <div className={styles['header-content']}>
            <h1 className={styles['header-title']}>Premium Earring Collection</h1>
